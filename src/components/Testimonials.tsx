...
const testimonials = [
     {
          ...
          text: "Aura technical and general enterprises limited delivered exceptional electrical installation for our factory. Professional, timely, and reliable service.",
          rating: 5,
     },
     {
     ...
     },
     {
          ...
          text: "Outstanding transformer installation work. Aura technical and general enterprises limited's technical expertise and safety standards are top-notch.",
          rating: 5,
     },
];
