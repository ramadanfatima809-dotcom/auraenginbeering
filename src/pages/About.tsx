...
const About = () => {
  return (
    <Layout>
      <SEO
        title="About Us - Aura technical and general enterprises limited"
        description="Learn about Aura technical and general enterprises limited, a leading provider of electrical and construction services in Kano, Nigeria. Our mission, vision, and core values."
        keywords="about Aura technical and general enterprises limited, engineering company Kano, electrical services Nigeria, construction company"
      />
      <PageHeader
        title="About Aura technical and general enterprises limited"
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            <AnimatedSection>
              <div>
                ...
                <p className="text-body-lg text-muted-foreground mt-4 leading-relaxed">
                  Aura technical and general enterprises limited is a leading provider of electrical and construction services based in Kano State, Nigeria. We specialize in electrical installations, building wiring, industrial electrical works, transformer installations, networking, and general construction.
                </p>
            ...
            <AnimatedSection delay={0.2}>
              <ImageWithFallback
                src={aboutCompany}
                alt="Aura technical and general enterprises limited professional engineer inspecting electrical installation with safety equipment"
